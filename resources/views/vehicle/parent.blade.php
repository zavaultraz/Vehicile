...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('asset/dashboard/plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css') }}">
  <!-- iCheck -->
  ...
  <!-- overlayScrollbars -->
  <link rel="stylesheet" href="{{ asset('asset/dashboard/plugins/overlayScrollbars/css/OverlayScrollbars.min.css') }}">
  <!-- Daterange picker -->
...
<body class="hold-transition sidebar-mini layout-fixed">
  <div class="wrapper">
    ...
    <!-- Navbar -->
    @include('vehicle.navbar')
    <!-- /.navbar -->

    <!-- Main Sidebar Container -->
    @include('vehicle.sidebar')
  ...
  <!-- Tempusdominus Bootstrap 4 -->
  <script src="{{ asset('asset/dashboard/plugins/tempusdominus-bootstrap-4/js/tempusdominus-bootstrap-4.min.js') }}"></script>
  <!-- Summernote -->
